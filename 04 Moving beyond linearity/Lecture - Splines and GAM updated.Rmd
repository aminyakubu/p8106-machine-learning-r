...
## Splines
We first look at the shape of cubic spline basis using B-spline representation. Note that the fitted line will be linear combination of these bases. They provide an equivalent fit but are not the same as the expression of cubic spline bases in the slides. 
